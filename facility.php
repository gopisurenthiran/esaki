        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay">
                    ...
                    <div class="breadcrumbs-text white-color">
                            <h1 class="page-title"><?php echo $fet->title; ?></h1>
                            <ul>
                                <li>
        ...
        <div class="container">
            ...
            <div class="row mt-5 mb-5">
                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                    <?php 
                    echo str_replace("graduation-cap","<i class='fa fa-graduation-cap'></i>",$fet->description); ?>
                </div>
                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 mt-5">
                     <img src="web_control/<?php echo $fet->imgurl; ?>">
                </div>
            </div>
        </div>

...
.rs-cta.style2 .partition-bg-wrap:after {
            ...
            <section class=" ">
                  <div class="container-fluid">
                    <div class="row">
                      <div class="col-12 ">
                        <div class="">
                          <img src="assets/images/bannerhomepage.webp" style="width: 100%;">
  ...
  <div class="container">
      <div class="row">
           <div class="col-lg-6 col-md-6 col-12 m-auto">
               <div class="e-commerce-brand">
                <h4>About us</h4>
                   ...
                   <p>Esaki Vidyaashram is synonymous with standardized education. To meet the growing academic challenges globally, 
                    we are determined to run the institution to shape the individuals into truly global citizens with human values.</p>
               </div>
               <div class="row">
                <div  class="col-12">
                    <div class="d-flex">
            ...
            <h5>Student</h5>
            <p>The growing academic challenges globally, we are determined </p>
            </div>
           </div>
           <div class="d-flex">
                <div>
           ...
           <img src="assets/images/boyimage.webp" class="first-section-image ">
           </div>
      </div>
  </div>
</section>
                        ...
                        <div class="col-lg-5 pr-65 md-pr-15 md-mb-50">
                            <div class="">
                                <div class="sec-title mb-40 wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                                    <div class="sub-title primary">Welcome to
Esaki Vidyaashram</div>

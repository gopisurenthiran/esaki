...
<?php 
  ...
  if(isset($_FILES['upload_picture'])) 
  {
    ...
    if(count($err) === 0) {
      ...
      $insert = mysqli_query($link,"insert into gallery(autoid,type,sort,status)values('$autoid','$type','$sort','$status')");

      if($upload_picture != "")
        {
          $secondname=rand(0,10000000000);
            $uploaddir = "uploads/campus/";
            $upload_pic = $uploaddir.$secondname.$upload_picture;     
          copy($_FILES['upload_picture']['tmp_name'], $upload_pic);
          chmod("$upload_pic",0777);
          mysqli_query($link,"UPDATE `gallery` SET `imgurl` = '$upload_pic' WHERE autoid ='$autoid'");
        }

      header("location:add_gallery.php?page=".$page."&msg=1");
    }
  }
}
    if($_POST['s1']=="Update"){
      ...
      $update = mysqli_query($link,"update gallery set type='$type',sort='$sort',status='$status' where autoid='$autoid'");
  ...
  if(isset($_FILES['upload_picture'])) 
  {
    ...
    if(count($err) === 0) {
      ...
      mysqli_query($link,"UPDATE `gallery` SET `imgurl` = '$upload_pic' WHERE autoid ='$autoid'");
        ...
        header("location:add_gallery.php?page=".$page."&pid=".$id."&msg=2");
  }else{
        header("location:add_gallery.php?page=".$page."&pid=".$id."&msg=2");
      }
            ...
            <div class="box">
              <div class="box-header">
                <div class="row">
                  ...
                  <div class="col-sm-2">
                    <a class="btn btn-success" style="text-align: right" href="gallery.php?page=<?php echo $page; ?>">View <?php echo $page; ?></a>
                  </div>
                </div>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                ...
                if(isset($_REQUEST['pid'])){
                    $id = $_REQUEST['pid'];
                  $sel_rw = mysqli_query($link,"select * from gallery where id=$id"); 
                  $row = mysqli_fetch_array($sel_rw);

                  $autoid=$row['autoid']; 

                }else{

                    list($max) = mysqli_fetch_row(mysqli_query($link,"SELECT MAX(id) AS max FROM `gallery`"));
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 no-pad">
                    <div class="form-group">
                      ...
                      <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 no-pad">
                        ...
                        <input type="hidden" class="form-control" name="id" value="<?php if(isset($_REQUEST['pid'])){ echo $row['id']; } ?>">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 no-pad">
                    <div class="form-group">
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 no-pad">
                        <label class="margin-left-50" for="childcategory_id">Category</label>
                      </div>
                      <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 no-pad">
                        <input type="text" class="form-control" name="type" value="<?php if(isset($_REQUEST['pid'])){ echo $row['type']; } ?>" required>
                      </div>
                    </div> 
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 no-pad <?php if($page=='Committees'){ echo "hide"; } ?>">
                    <div class="form-group">
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 no-pad">

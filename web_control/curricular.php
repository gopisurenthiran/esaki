...
<?php 
  ...
  if(isset($_POST['s1'])){
    ...
    if($_POST['s1']=="Update"){
      ...
      $update = mysqli_query($link,"update curricular set description='$description'");
  ...
  if(isset($_FILES['upload_picture'])) 
  {
    if($upload_picture != "")
      ...
      mysqli_query($link,"UPDATE `curricular` SET `imgurl` = '$upload_pic'");

    
        header("location:curricular.php?msg=2");
  }else{
        header("location:curricular.php?msg=2");
      }
      } 
            ...
            <div class="box">
              ...
              <div class="box-body">
                ...
                <?php } } 
                  ...
                  $sel_rw = mysqli_query($link,"select * from curricular"); 

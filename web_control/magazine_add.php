...
<?php 
  ...
  if(isset($_FILES['upload_picture'])) 
  {
      ...
      $insert = mysqli_query($link,"insert into magazine(autoid,name,sort,status)values('$autoid','$name','$sort','$status')");
      if($insert){
        if($upload_picture != "")
        {
          ...
          mysqli_query($link,"UPDATE `magazine` SET `pdf` = '$upload_pic' WHERE autoid ='$autoid'");
        }
        header("location:magazine_add.php?msg=1");
      }
    ...
    if($_POST['s1']=="Update"){
      ...
      $update = mysqli_query($link,"update magazine set name='$name',sort='$sort',status='$status' where autoid='$autoid'");
  ...
  if(isset($_FILES['upload_picture'])) 
  {
    if($upload_picture != "")
      ...
      mysqli_query($link,"UPDATE `magazine` SET `pdf` = '$upload_pic' where autoid='$autoid'");
        ...
        header("location:magazine_add.php?pid=$id&msg=2");
  }else{
       header("location:magazine_add.php?pid=$id&msg=2");
      }
      }
            ...
            <div class="box">
              ...
              <div class="box-body">
                ...
                if(isset($_REQUEST['pid'])){
                    $id = $_REQUEST['pid'];
                  $sel_rw = mysqli_query($link,"select * from magazine where id=$id"); 
                  ...
                  $autoid=$row->autoid; 
                    ...
                    list($max) = mysqli_fetch_row(mysqli_query($link,"SELECT MAX(id) AS max FROM `magazine`"));
               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 no-pad">
                    <div class="form-group">
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 no-pad">
                        <label class="margin-left-50" for="childcategory_id">Magazine Name</label>
                      </div> 
                      <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 no-pad">
                 ...
                 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 no-pad">
                    <div class="form-group">
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 no-pad">
                        <label class="margin-left-50" for="childcategory_id"> PDF </label>
                      </div>
                      <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 no-pad">
                        <input type="file" class="form-control" name="upload_picture">

                        <?php if(isset($_REQUEST['pid'])){ ?>
                          <a target="_blank" src="<?php echo $row->imgurl; ?>">View Uploaded Pdf</a>
                      <?php } ?>

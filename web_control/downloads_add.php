...
<?php 
  ...
  if(isset($_POST['s1'])){
    if($_POST['s1']=="Save"){
      ...
      $upload_picture = $_FILES['upload_picture1']['name'];
  if(isset($_FILES['upload_picture1'])) 
  {
   
      $insert = mysqli_query($link,"insert into downloads(autoid,title,sort,status)values('$autoid','$title','$sort','$status')");
      if($insert){
        ...
        if($upload_picture1 != "")
        {
          ...
          mysqli_query($link,"UPDATE `downloads` SET `pdf` = '$upload_pic' WHERE autoid ='$autoid'");
        }
        header("location:downloads_add.php?msg=1");
      }
    ...
    if($_POST['s1']=="Update"){
      ...
      $update = mysqli_query($link,"update downloads set title='$title',sort='$sort',status='$status' where autoid='$autoid'");
      ...
      header("location:downloads_add.php?pid=$id&msg=2"); 
    }
  }
            ...
            <div class="box">
              ...
              <div class="box-body">
                ...
                if(isset($_REQUEST['pid'])){
                    $id = $_REQUEST['pid'];
                  $sel_rw = mysqli_query($link,"select * from downloads where id=$id"); 
                  ...
                  $autoid=$row->autoid; 
                    ...
                    list($max) = mysqli_fetch_row(mysqli_query($link,"SELECT MAX(id) AS max FROM `downloads`"));
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 no-pad">
                        ...
                        <?php if(isset($_REQUEST['pid'])){ ?>
                          <a target="_blank" href="<?php echo $row->pdf; ?>" >View Uploaded PDF</a>
                          <?php } ?>
                      </div>
                    </div> 
                  </div>
